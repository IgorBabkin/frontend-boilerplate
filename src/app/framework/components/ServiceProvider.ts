...
import { getActions, getQuery, isClassInstance } from '@framework/components/operations';
import { initialize } from '@framework/initialize/OnInit';
import { IServiceMediatorKey } from '@framework/components/ServiceMediator';
